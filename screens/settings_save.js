...
class SettingsScreen extends React.Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState){
        ...
        console.log("settings getDerivedStateFromProps:", nextProps);
        if (prevState.settings !== nextProps.settings) {
            update.settings = nextProps.settings;
            console.log("settings getNewProps settings: ", nextProps.settings);
        }
        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <SettingsList style={styles.listItem} defaultItemSize={50}>
                    ...
                    />
                    <SettingsList.Item
                        title='Pause between stories'
                        titleInfo={this.state.settings.pauseBetweenStories.toString() + " secs"}
                        titleInfoStyle={styles.titleInfoStyle}
                        titleStyle={styles.listTitle}
                        onPress={() => this.props.navigation.navigate("SettingsEndOfStory")}
                    />
                    <SettingsList.Item
